...
public class AirlineConfigurationServiceTest extends AbstractTest {
   ...
   //Editar una configuración de aerolínea existente
		...
		protected void testCreateAndSave (int airlineId, int maxCancellationDays, int maxChildrenAge, double childrenDiscount, double maxBagWeight, double overweightBagPrice, final Class<?> expected){
		...
		protected void testEdit (int airlineConfigurationId, int maxCancellationDays, int maxChildrenAge, double childrenDiscount, double maxBagWeight, double overweightBagPrice, final Class<?> expected){
