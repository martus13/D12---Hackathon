...
public class CommentServiceTest extends AbstractTest {
	...
	public void driverCreate() {
		...
		for (int i = 0; i < testingData.length; i++){
			...
			this.testCreateAndSave((int) testingData[i][0], (String) testingData[i][1], (String)testingData[i][2],(String)testingData[i][3],(int)testingData[i][4],(int)testingData[i][5],(int)testingData[i][6],(int)testingData[i][7],(Class<?>) testingData[i][8]);
		}
	...
	public void driverEdit() {
		...
		for (int i = 0; i < testingData.length; i++){
			...
			this.testFindOneAndSave((int) testingData[i][0], (String) testingData[i][1], (String)testingData[i][2],(String)testingData[i][3],(int)testingData[i][4],(int)testingData[i][5],(int)testingData[i][6],(int)testingData[i][7],(Class<?>) testingData[i][8]);
		}
	...
	public void testfindByAirlineId(){
		...
		Collection<Comment> comments = this.commentService.findByAirlineId(118);
		Assert.notNull(comments);
		
		Assert.isTrue(comments.size()==2);
		System.out.println("Encontrados los dos comentarios");
	}
	protected void testCreateAndSave (int airlineId, String user, String type, String commentText, int airlineRating ,int comfort, int service, int flight, final Class<?> expected){
...
protected void testFindOneAndSave (int commentId, String user, String type, String commentText, int airlineRating ,int comfort, int service, int flight, final Class<?> expected){
	...
	protected void testDelete (int commentId, String user, final Class<?> expected){
